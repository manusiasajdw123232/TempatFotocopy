...
private void kosongkanForm() {
    ...
    // Reset ID transaksi yang dipilih
    idTransaksiTerpilih = -1;

    // Kosongkan ID Transaksi
    txtIdTransaksi.setText("");

    // Tanggal otomatis hari ini
    txtTanggal.setText(LocalDate.now().toString());

    // ID User otomatis dari session login
    txtIdUser.setText(String.valueOf(Session.idUser));

    // Kosongkan input pelanggan
    txtIdPelanggan.setText("");

    // Kosongkan total harga
    txtTotalHarga.setText("");
    txtJumlah.setText("");
    txtSatuan.setText("");

    // Reset ComboBox Layanan ke pilihan pertama
    if (cmbLayanan.getItemCount() > 0) {
    cmbLayanan.setSelectedIndex(0);
}

    // Fokus kembali ke ID Pelanggan
...
private void tampilLayanan() {
    ...
    try {
        ...
        // Tambahkan semua layanan dari database
        while (rs.next()) {
        ...
        JOptionPane.showMessageDialog(
            null,
            "Gagal memuat data layanan : " + e.getMessage()
        );
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(txtSatuan, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(txtTotalHarga, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel8)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cmbLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(35, 35, 35)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(jLabel7)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtSatuan, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSImpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSImpanActionPerformed
        ...
        // CEK LAYANAN
        Object selected = cmbLayanan.getSelectedItem();
        ...
        String layanan = selected.toString();

        if (layanan.trim().isEmpty()) {
            JOptionPane.showMessageDialog(
                null,
        ...
        String sqlLayanan =
    "SELECT id_layanan FROM layanan WHERE nama_layanan = ?";

PreparedStatement psLayanan =
    conn.prepareStatement(sqlLayanan);

        psLayanan.setString(1, layanan);

        ResultSet rsLayanan =
            psLayanan.executeQuery();
        ...
        String sql =
"INSERT INTO transaksi (tanggal,id_user,id_pelanggan,id_layanan,total_harga) VALUES(?,?,?,?,?)";
...
pst.setDate(1, Date.valueOf(tanggal));
pst.setInt(2, Session.idUser);
pst.setInt(3, idPelangganInt);
pst.setInt(4, idLayanan);
...
psDetail.setInt(3, Integer.parseInt(jumlah));
psDetail.setDouble(4, total);
...
psDetail.close();
    ...
    if (baris != -1) {
        ...
        cmbLayanan.setSelectedItem(
        tblTransaksi.getValueAt(baris,6).toString()
        );

        txtTotalHarga.setText(
        tblTransaksi.getValueAt(baris,7).toString()
        );
    }
...
if (selected == null || cmbLayanan.getSelectedIndex() == 0) {
    JOptionPane.showMessageDialog(
        null,
        "Silakan pilih layanan terlebih dahulu!"
    );
...
String layanan = selected.toString();
    ...
    try {
        ...
        if(rs.next()){
            idLayanan=rs.getInt("id_layanan");
        }
        ...
        pst.setInt(2,Integer.parseInt(idUser));

        pst.setInt(3,Integer.parseInt(idPelanggan));
        ...
        pst.setInt(6,idTransaksiTerpilih);
    ...
    private void cmbLayananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbLayananActionPerformed
        // TODO add your handling code here:
         if(cmbLayanan.getSelectedIndex()==0){
        txtSatuan.setText("");
        return;
    }
    ...
    try{
        ...
        String sql =
        "SELECT harga FROM layanan WHERE nama_layanan=?";
        ...
        ps.setString(1, selected.toString());
    ...
    try{
        ...
        double harga =
        Double.parseDouble(txtSatuan.getText());

        int jumlah =
        Integer.parseInt(txtJumlah.getText());

        txtTotalHarga.setText(
            String.valueOf(harga*jumlah)
        );
