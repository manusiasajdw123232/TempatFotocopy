...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Jul 2026 pada 14.55
...
(2, 1, 500000.00, 430000.00, 'QRIS'),
(3, 3, 10000.00, 5000.00, 'CASH');
...
INSERT INTO `transaksi` (`id_transaksi`, `tanggal`, `id_user`, `id_pelanggan`, `total_harga`, `status`) VALUES
(1, '2026-07-05', 2, 1, 70000.00, 'Diproses'),
(2, '2026-07-11', 2, 4, 50000.00, 'Diproses'),
(3, '2026-07-13', 2, 1, 5000.00, 'Diproses');
